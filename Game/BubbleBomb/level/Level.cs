...
/// <summary>
/// Клас, що представляє собою рівень гри.
/// </summary>
partial class Level : GameObjectList
{
    ...
    /// <summary>
    /// Прапорець, що вказує, чи заблокован рівень.
    /// </summary>
    protected bool locked;

    /// <summary>
    /// Прапорець, що вказує, чи вирішений рівень.
    /// </summary>
    ...
    /// <summary>
    /// Кількість крапель а рівні.
    /// </summary>
    public static int[] countWaterDrop = new int[40];
    ...
    public Level(int levelIndex)
    {
        ...
        this.LoadTiles("Content/Levels/" + levelIndex + ".txt",levelIndex);
    }
