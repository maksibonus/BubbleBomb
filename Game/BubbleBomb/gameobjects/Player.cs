...
partial class Player : AnimatedGameObject
{
    ...
    /// <summary>
    /// Персонаж стоїть на поверхні.
    /// </summary>
    protected bool isOnTheGround;

    /// <summary>
    /// Попередня позиція по висоті.
    /// </summary>
    protected float previousYPosition;

    /// <summary>
    /// Прапорець, що вказує, чи живий персонаж.
    /// </summary>
    protected bool isAlive;

    /// <summary>
    /// Прапорець, що вказує, чи вибухнув персонаж.
    /// </summary>
    protected bool exploded;

    /// <summary>
    /// Прапорець, що вказує, чи пройден рівень.
    /// </summary>
    protected bool finished;

    /// <summary>
    /// Прапорець, що вказує, чи під персонажем холодний блок.
    /// </summary>
    protected bool walkingOnIce;
        
    /// <summary>
    /// Прапорець, що вказує, чи під персонажем гарячий блок.
    /// </summary>
    ...
    /// <summary>
    /// Дії, якщо персонаж помер.
    /// </summary>
    /// <param name="falling">Вказує, чи впав персонаж.</param>
    ...
    /// <summary>
    /// Дії, якщо гравець пройшов рівень.
    /// </summary>
